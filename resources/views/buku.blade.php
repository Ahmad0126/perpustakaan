                        ...
                        <table class="table align-items-center mb-0" id="myTable">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" onclick="sortTable(2)">Judul</th>
                                    <th scope="col" onclick="sortTable(3)">Penulis</th>
                                    <th scope="col" onclick="sortTable(4)">Kategori</th>
                                    <th scope="col" onclick="sortTable(5)">Tanggal Rilis</th>
                                    <th>Aksi</th>
                                </tr>
                            </thead>
                            <tbody>
